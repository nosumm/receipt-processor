...
func main() {
	...
	router.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		apiInfo := `{
			...
			"example": {
				"Process Receipt": {
					"curl": "curl -X POST http://localhost:8080/process-receipt -d '{\"Retailer\": \"My Retailer\",\"PurchaseDate\": \"2024-11-28T10:30:00Z\", \"PurchaseTime\": \"2024-11-28T10:30:00Z\", \"Items\": [{\"shortDescription\": \"Item 1\",\"price\": \"10.00\"},{\"shortDescription\": \"Item 2\",\"price\": \"20.50\"}], \"Total\": \"30.50\", \"RetailerId\": \"123\"}' -H \"Content-Type: application/json\"",
					"response": "{\"id\":\"22205988-20ad-42ce-9c43-804766bd019e\"}"
				},
				"Get Points": {
					"curl": "curl http://localhost:8080/get-points/22205988-20ad-42ce-9c43-804766bd019e",
					"response": "{\"points\":47}"
				}
			}
		}`
